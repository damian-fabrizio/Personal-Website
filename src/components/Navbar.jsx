...
import resume from "../web/FinalResumeDF.pdf";

const Navbar = () => {
  return (
    <nav className="flex items-center justify-between py-3 p-24">
      <motion.a
        href={resume}
        download="Resume-Damian-Fabrizio"
        target="_blank"
      ...
      >
        <a
          href="https://github.com/damian-fabrizio?tab=repositories"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://www.linkedin.com/in/damian-fabrizio-99b691155/"
          target="_blank"
          rel="noopener noreferrer"
        >
